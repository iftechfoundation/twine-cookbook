...
This example uses a complex combination of the [Vars Section](https://klembot.github.io/chapbook/guide/state/the-vars-section.html), [`[JavaScript]` modifier](https://klembot.github.io/chapbook/guide/advanced/using-javascript-in-passages.html), and internal JavaScript functionality in Chapbook, including the use of the function *window.go()*.
